--- Copied from: https://github.com/LunarVim/starter.lvim
--- (HUGE thanks to whoever made the above config)
...
local config = {
	...
	-- 				{
	-- 					name = "openjdk17",
	-- 					path = "/Library/Java/JavaVirtualMachines/openjdk17/Contents/Home",
	-- 				},
	-- 				-- {
	-- 				-- 	name = "JavaSE-11",
